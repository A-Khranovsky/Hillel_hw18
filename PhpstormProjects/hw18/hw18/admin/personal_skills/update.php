...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($errorsCounter == 0) {
        $sql = "update personal_skills set name = :name, score = :score where id = :id;";
        ...
        $result->execute();
        $_SESSION['flash'] = ['status' => 'success', 'message' => 'Personal skill '.$_POST['Name'].' успешно обновлен'];
        header("Location: /admin/personal_skills/");
    }
}
else {
    $sql = "select * from personal_skills where id = :id;";
...
<?= breadcrumbs(
    [
        ...
        [
            'href' => '/admin/personal_skills/update.php',
            'title' => 'Update'
        ]
    ]
)?>
        ...
        <div class="row justify-content-center">
            <div class="col-4">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="score" name="Score"  value="<?= $data['score'] ?? $_POST['Score']?>">
