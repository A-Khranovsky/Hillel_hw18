...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($errorsCounter == 0) {
        require_once('../db.php');
        $sql = "INSERT INTO professional_skills (name, score) VALUES (:name, :score);";
        ...
        $_SESSION['flash'] = ['status' => 'success', 'message' => 'Professional skill '.$_POST['Name'].' успешно добавлен'];
...
<?= breadcrumbs(
    [
        ...
        [
            'href' => '/admin/professional_skills/index.php',
            'title' => 'Create'
        ]
    ]
)?>
